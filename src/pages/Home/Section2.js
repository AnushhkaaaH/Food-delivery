        ...
        <Container>
            <Row>
                <Col lg={{ span:8, offset: 2}} className='text-center'>
                    <h2>The food tastes better when you eat it with your loved one!</h2>
                    <p>
                    ...
                    <div>
                      <a href='#about' className='btn order_now btn_red'> Explore Full Menu</a>
                    </div>
        ...
        <Container>
            <Row className='justify-content-md-center'>
                {mockData.map((cardData, index) => (
                    <Col md={6} lg={4} className='mb-md-0' key={index}>
